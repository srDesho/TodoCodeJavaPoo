...
public class EditarDatos extends javax.swing.JFrame {
    ...
    public EditarDatos(int idMasco) {
        control = new ControladoraLogica();
        this.idMasco = idMasco;
        initComponents();
        cargarDatos(idMasco); // Cargamos los datos sin necesidad de usar el método formWindowOpened(java.awt.event.WindowEvent evt)
        setImageLabel( lblLogoCargaDato, "src/main/resources/images/logoPeluqueriaCanina.png");
    }
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(cmbAEspecial, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            .addComponent(jLabel3)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(txtRaza, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtCelDuenio, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addContainerGap())
                    .addComponent(txtObs, javax.swing.GroupLayout.DEFAULT_SIZE, 88, Short.MAX_VALUE)))
        );

        lblLogoCargaDato.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/logoPeluqueriaCanina.png"))); // NOI18N
        lblLogoCargaDato.setName("lblLogo"); // NOI18N

        btnGuardar.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnGuardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/guardarIcon.png"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(43, 43, 43)
                        .addComponent(lblLogoCargaDato, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.modificarMascota(masco, txtNombre.getText(), txtRaza.getText() , txtColor.getText()
    ...
    private javax.swing.JLabel lblLogoCargaDato;
    ...
    private void cargarDatos(int idMasco) {
        masco = control.traerMascota(idMasco);
        ...
        if(masco.getAtencio_especial().equals("SI")) {
            cmbAEspecial.setSelectedIndex(1);
        } else if (masco.getAtencio_especial().equals("NO")) {
